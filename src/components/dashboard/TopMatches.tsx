  ...
  return (
    <div className="bg-white border border-[#d8dbe4] rounded-[10px] p-5 shadow-[0_5px_60px_rgba(151,155,192,0.2)]">
      <div className="flex items-center justify-between mb-4">
        ...
        <a href="/jobs" className="text-[11px] text-[#0052ff] font-semibold hover:underline">View all →</a>
      </div>
        ...
        {matches.map((match, i) => (
          <div key={i} className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[12px] font-bold text-[#0a0b0d] truncate">{match.jobTitle}</div>

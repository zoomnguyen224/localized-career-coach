...
export function CompanyIntelBanner({ company, role, process }: CompanyIntelBannerProps) {
  ...
  return (
    <div className="bg-[#0a0b0d] rounded-[10px] p-4 mb-4">
      <div className="flex items-center gap-2 mb-3">
        <div className="w-8 h-8 rounded-lg bg-[#0052ff]/20 flex items-center justify-center text-[11px] font-bold text-white">
        ...
        <div className="ml-auto bg-[#0052ff]/20 px-2 py-1 rounded-full">
          <span className="text-[9px] font-bold text-[#0052ff]">MENA Intel</span>
        </div>
      </div>
